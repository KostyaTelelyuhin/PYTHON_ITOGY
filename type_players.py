...
class Player(pygame.sprite.Sprite):
    def __init__(self, y = 450):
        ...
        self.surf = pygame.image.load("/Users/forcs2/Desktop/Geometry_dash/spiral.png").convert()
        self.x = 1/4 *WIDTH
        self.y = y
        self.angle = 0
    ...
    def rotate(self):
        self.surf = pygame.transform.rotate(pygame.image.load("/Users/forcs2/Desktop/Geometry_dash/spiral.png").convert(), self.angle)
        self.rect = self.surf.get_rect(
            center=(self.x, self.y)
        )
...
class UFO:
    ...
    def draw(self):
        ...
        '''
        ufo_image = pygame.image.load("/Users/forcs2/Desktop/Geometry_dash/UFO.png")
        ufo_rect = ufo_image.get_rect()

        ufo_rect.x = self.x
        ufo_rect.y = self.y - self.a
